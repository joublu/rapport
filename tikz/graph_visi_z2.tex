...
\begin{tikzpicture}[
    ...
    greenhighlight/.style={draw=\darkgreen, line width=5pt,opacity=0.3},
]
...
% dessiner la visi
\draw[greenhighlight] (P1)--(P5)--(P3)--(P2)--(P7)--(P8)--(P4);

% legende
\begin{scope}[shift={(3,2)}]
  \node[POI, circle, inner sep=2pt] at (0.1,0.47) {};
  \node at (1.35,0.47) {POI};
  \draw[greenhighlight] (0,0) -- (0.8,0);
  \node at (2.15,0) {Visibilité de $z_2$};
